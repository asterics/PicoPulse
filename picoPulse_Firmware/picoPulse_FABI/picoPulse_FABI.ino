...
void setActive (int active) {
  ...
  if (active) setPixel(0,PULSE_BRIGHTNESS,0); else setPixel(150,0,0);
}
...
void setPulseTime(int newTime) {
  ...
  writeSettings();
  char message[25];
  sprintf(message,"time:%d",settings.pulseTime);
